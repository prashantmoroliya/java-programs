...
public class FileOperation {
    ...
    boolean saved, newFileFlag;
    String fileName, applicationTitle = "Notepad by Darth Vader";
    ...
    boolean saveAsFile() {
        ...
        do {
            ...
            if (JOptionPane.showConfirmDialog(
                    this.npd.f, "<html>" + temp.getPath() + "already exists." +
                            "<br>Do you want to replace it?<html>", "Save As",
